      ...
      <AuthGuard>
        <div style={{ minHeight: "100vh", background: "#0d1526", fontFamily: FONT }}>
          ...
          <div style={{ maxWidth: 500, margin: "80px auto", padding: "0 1.5rem", textAlign: "center" }}>
            <div style={{ background: "#111c30", border: "1.5px solid rgba(59,130,246,.3)", borderRadius: 20, padding: "40px 32px" }}>
              <GraduationCap size={48} color="#3B82F6" style={{ margin: "0 auto 16px" }} />
              <h2 style={{ color: "#ffffff", fontWeight: 800, fontSize: "1.25rem", marginBottom: 8 }}>Awaiting Approval</h2>
              <p style={{ color: "#8b9dc3", fontSize: "0.875rem", lineHeight: 1.6, marginBottom: 20 }}>
  ...
  return (
    <AuthGuard>
      <div style={{ minHeight: "100vh", background: "#0d1526", fontFamily: FONT }}>
        ...
        {/* Hero */}
        <div style={{ background: `linear-gradient(135deg, ${"#0d1526"} 0%, ${"#111c30"} 60%, ${"#0d1526"} 100%)`, borderBottom: `1px solid ${"rgba(255,255,255,.07)"}`, padding: "24px 1.5rem" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12 }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
                  <GraduationCap size={22} color="#3B82F6" />
                  <h1 style={{ fontWeight: 900, fontSize: "1.4rem", color: "#ffffff" }}>Class Dashboard</h1>
                ...
                <p style={{ color: "#4a6a8a", fontSize: "0.82rem" }}>Welcome back, {user?.email?.split("@")[0]}</p>
              </div>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 16, flexWrap: "wrap" }}>
                {myClasses.map((cls: any) => (
                  <button key={cls.id} onClick={() => setSelectedClass(cls.id)} style={{
                    ...
                    border: `1px solid ${selectedClass === cls.id ? "#3B82F6" : "rgba(255,255,255,.07)"}`,
        ...
        {showCreate && (
          <div style={{ position: "fixed", inset: 0, zIndex: 500, background: "rgba(0,0,0,.7)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }}>
            <div style={{ background: "#111c30", border: "1.5px solid rgba(59,130,246,.3)", borderRadius: 20, padding: "28px 24px", maxWidth: 480, width: "100%", animation: "pw-pop .35s ease" }}>
              <h2 style={{ fontWeight: 800, color: "#ffffff", fontSize: "1.1rem", marginBottom: 20 }}>Create New Class</h2>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  ...
                  <div key={f.label}>
                    <label style={{ display: "block", fontSize: "0.7rem", color: "#8b9dc3", fontWeight: 600, marginBottom: 5, textTransform: "uppercase" as const, letterSpacing: ".04em" }}>{f.label}</label>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                  {[
                    ...
                    <div key={f.label}>
                      <label style={{ display: "block", fontSize: "0.7rem", color: "#8b9dc3", fontWeight: 600, marginBottom: 5, textTransform: "uppercase" as const, letterSpacing: ".04em" }}>{f.label}</label>
                      <select value={f.val} onChange={e => f.set(e.target.value)} style={{ width: "100%", padding: "10px 12px", background: "rgba(255,255,255,.06)", border: `1.5px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 10, color: "#ffffff", fontFamily: FONT, fontSize: "0.875rem", outline: "none" }}>
                        {f.opts.map(o => <option key={o} value={o} style={{ background: "#0d1526" }}>{o}</option>)}
                      </select>
                    </div>
                  ))}
                </div>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 20 }}>
                <button onClick={createClass} disabled={!className || creating} className={className && !creating ? "btn-3d-blue" : ""} style={{ flex: 1, padding: "12px", fontSize: "0.875rem", background: !className ? "#1a2540" : undefined, color: !className ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, cursor: !className ? "not-allowed" : "pointer", fontFamily: FONT }}>
        ...
        {myClasses.length === 0 && (
          <div style={{ maxWidth: 500, margin: "80px auto", padding: "0 1.5rem", textAlign: "center" }}>
            <div style={{ background: "#111c30", border: `2px dashed ${"rgba(255,255,255,.07)"}`, borderRadius: 20, padding: "48px 32px" }}>
              <BookOpen size={44} color={"#4a6a8a"} style={{ margin: "0 auto 16px" }} />
              <h2 style={{ color: "#ffffff", fontWeight: 800, fontSize: "1.1rem", marginBottom: 8 }}>No Classes Yet</h2>
              <p style={{ color: "#4a6a8a", fontSize: "0.875rem", marginBottom: 20 }}>Create your first class to start managing students.</p>
        ...
        {activeClass && (
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 1.5rem 60px" }}>
            ...
            {/* Class info bar */}
            <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "16px 20px", margin: "20px 0", display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              <div style={{ flex: 1, minWidth: 200 }}>
                <div style={{ fontWeight: 800, color: "#ffffff", fontSize: "1rem" }}>{activeClass.name}</div>
                <div style={{ fontSize: "0.72rem", color: "#4a6a8a", marginTop: 2 }}>{activeClass.subject} - {activeClass.yearLevel}</div>
              </div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                <span style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.875rem" }}>{classEnrolls.length} students</span>
              </div>
              {activeSub ? (
            ...
            <div style={{ display: "flex", background: `rgba(255,255,255,.04)`, borderRadius: 12, padding: 4, marginBottom: 24, overflowX: "auto" as const, gap: 2 }}>
              {TAB_LIST.map(t => (
                <button key={t.key} onClick={() => setTab(t.key)} style={{
                  ...
                  border: tab === t.key ? `1px solid ${"rgba(255,255,255,.14)"}` : "1px solid transparent",
              ...
              <div>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12, marginBottom: 24 }}>
                  {[
                    ...
                    <div key={s.label} style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "16px", display: "flex", gap: 10, alignItems: "center" }}>
                      ...
                      <div>
                        <div style={{ fontSize: "0.65rem", color: "#4a6a8a", textTransform: "uppercase" as const, letterSpacing: ".04em" }}>{s.label}</div>
                        <div style={{ fontWeight: 900, color: "#ffffff", fontSize: "1rem", lineHeight: 1.2 }}>{s.val}</div>
                      </div>
                    </div>
                  ))}
                </div>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "18px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
                      <Trophy size={16} color="#f59e0b" />
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Class Leaderboard</h3>
                    </div>
                    {studentStates.slice().sort((a: any, b: any) => (b.xp ?? 0) - (a.xp ?? 0)).slice(0, 5).map((st: any, i: number) => (
                      <div key={st.id} style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0", borderBottom: i < 4 ? `1px solid ${"rgba(255,255,255,.07)"}` : "none" }}>
                        <div style={{ width: 24, height: 24, borderRadius: "50%", background: i === 0 ? "#f59e0b" : i === 1 ? "#94a3b8" : i === 2 ? "#b45309" : "#1a2540", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "0.68rem", fontWeight: 800, color: "#ffffff", flexShrink: 0 }}>{i + 1}</div>
                        <div style={{ flex: 1, fontWeight: 600, color: "#ffffff", fontSize: "0.8rem" }}>{st.email?.split("@")[0]}</div>
                    ...
                    {studentStates.length === 0 && <p style={{ color: "#4a6a8a", fontSize: "0.78rem", textAlign: "center", padding: "16px 0" }}>No students enrolled yet</p>}
                  </div>
                  <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "18px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
                      <Megaphone size={16} color="#60a5fa" />
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Post Announcement</h3>
                    </div>
                    ...
                    <button onClick={postAnnouncement} disabled={!announce || announcing} className={announce && !announcing ? "btn-3d-blue" : ""} style={{ width: "100%", padding: "10px", fontSize: "0.85rem", background: !announce ? "#1a2540" : undefined, color: !announce ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, cursor: !announce ? "not-allowed" : "pointer", fontFamily: FONT, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                    ...
                    {classAnnouncements.length > 0 && (
                      <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 6, maxHeight: 120, overflowY: "auto" as const }}>
                        {classAnnouncements.slice(0, 3).map((a: any) => (
                          <div key={a.id} style={{ background: "#1a2540", borderRadius: 8, padding: "8px 10px" }}>
                            <div style={{ fontSize: "0.75rem", color: "#ffffff" }}>{a.text}</div>
                            <div style={{ fontSize: "0.62rem", color: "#4a6a8a", marginTop: 3 }}>{new Date(a.createdAt).toLocaleDateString("en-NZ")}</div>
                          </div>
                        ))}
                      </div>
                    )}
            ...
            {tab === "students" && (
              <div>
                {classEnrolls.length === 0 ? (
                  <div style={{ background: "#111c30", border: `2px dashed ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "48px", textAlign: "center" }}>
                    <Users size={40} color={"#4a6a8a"} style={{ margin: "0 auto 12px" }} />
                    <p style={{ color: "#4a6a8a", fontSize: "0.875rem", marginBottom: 8 }}>No students enrolled yet.</p>
                    <p style={{ color: "#4a6a8a", fontSize: "0.82rem" }}>Share the class code <strong style={{ color: "#76AD25", fontFamily: "monospace", fontSize: "1rem" }}>{activeClass.joinCode}</strong> with your students.</p>
                  </div>
                ) : (
                  <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, overflow: "hidden" }}>
                    ...
                    {studentStates.slice().sort((a: any, b: any) => (b.xp ?? 0) - (a.xp ?? 0)).map((st: any, i: number) => (
                      <div key={st.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 20px", borderBottom: `1px solid ${"rgba(255,255,255,.07)"}` }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ fontSize: "0.7rem", color: "#4a6a8a" }}>{st.email}</div>
                        </div>
                        <div style={{ display: "flex", gap: 16 }}>
                          {[
                            ...
                            <div key={s.label} style={{ textAlign: "center", minWidth: 48 }}>
                              ...
                              <div style={{ fontSize: "0.58rem", color: "#4a6a8a" }}>{s.label}</div>
                            </div>
                          ))}
                        </div>
                      </div>
            ...
            {/* MODULES */}
            {tab === "modules" && (
              <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem", marginBottom: 6 }}>Assigned Modules</h3>
                <p style={{ color: "#4a6a8a", fontSize: "0.8rem", marginBottom: 16 }}>Control which modules your class can access.</p>
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(220px, 1fr))", gap: 10 }}>
                  {["module-1-financial-decision-making", "module-2-budgeting-basics", "module-3-saving-and-investing", "module-4-financial-viability", "module-5-credit-and-debt"].map(mod => {
                    ...
                    return (
                      <div key={mod} style={{ background: assigned ? "rgba(118,173,37,.08)" : "#1a2540", border: `1.5px solid ${assigned ? "rgba(118,173,37,.25)" : "rgba(255,255,255,.07)"}`, borderRadius: 10, padding: "12px 14px", display: "flex", alignItems: "center", gap: 10 }}>
                        {assigned ? <Unlock size={14} color="#76AD25" /> : <Lock size={14} color={"#4a6a8a"} />}
                        <div style={{ flex: 1, fontWeight: 600, color: assigned ? "#ffffff" : "#8b9dc3", fontSize: "0.8rem" }}>{modName}</div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 16 }}>
                    <Trophy size={16} color="#f59e0b" />
                    <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Set Class Challenge</h3>
                  </div>
                  <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                      <div>
                        <label style={{ display: "block", fontSize: "0.7rem", color: "#8b9dc3", fontWeight: 600, marginBottom: 5, textTransform: "uppercase" as const }}>Bonus XP</label>
                      ...
                      <div>
                        <label style={{ display: "block", fontSize: "0.7rem", color: "#8b9dc3", fontWeight: 600, marginBottom: 5, textTransform: "uppercase" as const }}>Deadline</label>
                    ...
                    <button onClick={setChallenge} disabled={!challengeText} className={challengeText ? "btn-3d-amber" : ""} style={{ padding: "11px", fontSize: "0.875rem", background: !challengeText ? "#1a2540" : undefined, color: !challengeText ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, cursor: !challengeText ? "not-allowed" : "pointer", fontFamily: FONT }}>
                      Set Challenge
                    </button>
                  </div>
                    ...
                    try {
                      ...
                      return (
                        <div style={{ background: "rgba(245,158,11,.08)", border: "1px solid rgba(245,158,11,.2)", borderRadius: 10, padding: "12px 14px", marginTop: 14 }}>
                          ...
                          <div style={{ color: "#ffffff", fontSize: "0.82rem", marginBottom: 6 }}>{ch.text}</div>
                          <div style={{ display: "flex", gap: 12, fontSize: "0.72rem", color: "#8b9dc3" }}>
                ...
                <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                    ...
                    <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Challenge Ideas</h3>
                  </div>
                  <p style={{ color: "#4a6a8a", fontSize: "0.78rem", marginBottom: 14 }}>Click to use as a template</p>
                  {["Complete 3 lessons this week", "Get your net worth above $10,000", "Buy your first stock and hold it for 7 days", "Set up a KiwiSaver goal and reach 50% progress", "Earn 500 XP this week", "Try every game in the casino and reflect on what you learned", "Get a 5-day lesson streak", "Invest in 3 different sectors"].map(idea => (
                    <button key={idea} onClick={() => setChallengeText(idea)} style={{ width: "100%", textAlign: "left", background: "#1a2540", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 8, padding: "9px 12px", marginBottom: 6, color: "#8b9dc3", fontSize: "0.78rem", cursor: "pointer", fontFamily: FONT, transition: "all .12s" }}>
                      {idea}
                    </button>
                  ))}
                </div>
            ...
            {tab === "tools" && (
              <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                ...
                {/* Subscription */}
                <div style={{ background: activeSub ? "linear-gradient(135deg,#0a2010,#0f2818)" : "#111c30", border: `1.5px solid ${activeSub ? "rgba(118,173,37,.3)" : "rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                      <Shield size={16} color={activeSub ? "#76AD25" : "#f59e0b"} />
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Class Subscription</h3>
                    </div>
                    {activeSub ? (
                  ...
                  {activeSub ? (
                      ...
                      <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 14 }}>
                        {[
                          ...
                          <div key={s.label} style={{ background: "rgba(118,173,37,.08)", borderRadius: 8, padding: "8px 12px" }}>
                            ...
                            <div style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.82rem" }}>{s.val}</div>
                          </div>
                        ))}
                      </div>
                      <div style={{ borderTop: "1px solid rgba(255,255,255,.06)", paddingTop: 14 }}>
                        <div style={{ fontSize: "0.72rem", color: "#4a6a8a", marginBottom: 6 }}>Renew with a new plan code:</div>
                        <div style={{ display: "flex", gap: 8 }}>
                          ...
                          <button onClick={activateSubscription} disabled={!planCodeInput || subLoading} className={planCodeInput && !subLoading ? "btn-3d-green" : ""} style={{ padding: "0 18px", background: !planCodeInput ? "#1a2540" : undefined, color: !planCodeInput ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, fontSize: "0.82rem", cursor: !planCodeInput ? "not-allowed" : "pointer", fontFamily: FONT }}>
                            Renew
                          </button>
                        </div>
                      </div>
                    ...
                    <div>
                      <p style={{ color: "#4a6a8a", fontSize: "0.78rem", marginBottom: 14, lineHeight: 1.5 }}>
                      ...
                      <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                        ...
                        <button onClick={activateSubscription} disabled={!planCodeInput || subLoading} className={planCodeInput && !subLoading ? "btn-3d-green" : ""} style={{ padding: "0 20px", background: !planCodeInput ? "#1a2540" : undefined, color: !planCodeInput ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, fontSize: "0.875rem", cursor: !planCodeInput ? "not-allowed" : "pointer", fontFamily: FONT }}>
                      ...
                      <div style={{ marginTop: 12, background: "#1a2540", borderRadius: 8, padding: "10px 12px", fontSize: "0.75rem", color: "#4a6a8a" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
                  ...
                  <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      ...
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Boost Student XP</h3>
                    </div>
                    <p style={{ color: "#4a6a8a", fontSize: "0.78rem", marginBottom: 14 }}>Manually award XP to a student for participation or great work.</p>
                    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                      <select value={boostEmail} onChange={e => setBoostEmail(e.target.value)} style={{ width: "100%", padding: "10px 12px", background: "rgba(255,255,255,.06)", border: `1.5px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 10, color: boostEmail ? "#ffffff" : "#4a6a8a", fontFamily: FONT, fontSize: "0.875rem", outline: "none" }}>
                        <option value="" style={{ background: "#0d1526" }}>Select student...</option>
                        {studentStates.map((s: any) => <option key={s.id} value={s.email} style={{ background: "#0d1526" }}>{s.email?.split("@")[0]} ({s.email})</option>)}
                      </select>
                      ...
                      <button onClick={boostStudentXP} disabled={!boostEmail} className={boostEmail ? "btn-3d-amber" : ""} style={{ padding: "11px", fontSize: "0.875rem", background: !boostEmail ? "#1a2540" : undefined, color: !boostEmail ? "#4a6a8a" : undefined, border: "none", borderRadius: 10, fontWeight: 700, cursor: !boostEmail ? "not-allowed" : "pointer", fontFamily: FONT }}>
                        Award XP
                      </button>
                    </div>
                  </div>
                  ...
                  <div style={{ background: "#111c30", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 14, padding: "20px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      ...
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Class XP Multiplier</h3>
                    </div>
                    <p style={{ color: "#4a6a8a", fontSize: "0.78rem", marginBottom: 14 }}>Boost XP rewards for everyone in this class.</p>
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8, marginBottom: 14 }}>
                      {[1.0, 1.5, 2.0, 3.0].map(m => (
                        <button key={m} onClick={() => setXPMultiplier(m)} style={{
                          ...
                          background: activeClass.xpMultiplier === m ? "rgba(167,139,250,.2)" : "#1a2540",
                          border: `1.5px solid ${activeClass.xpMultiplier === m ? "rgba(167,139,250,.5)" : "rgba(255,255,255,.07)"}`,
                          cursor: "pointer", fontFamily: FONT, transition: "all .15s",
                        }}>
                          <div style={{ fontWeight: 900, color: activeClass.xpMultiplier === m ? "#a78bfa" : "#ffffff", fontSize: "1rem" }}>{m}x</div>
                          <div style={{ fontSize: "0.6rem", color: "#4a6a8a" }}>{m === 1 ? "Normal" : m === 1.5 ? "Boost" : m === 2 ? "Double" : "Triple"}</div>
                        </button>
                      ))}
                    </div>
                    <div style={{ background: "#1a2540", border: `1px solid ${"rgba(255,255,255,.07)"}`, borderRadius: 8, padding: "10px 12px", fontSize: "0.75rem", color: "#4a6a8a" }}>
                  ...
                  <div style={{ background: "linear-gradient(135deg,#0a2010,#0f2818)", border: "1px solid rgba(118,173,37,.2)", borderRadius: 14, padding: "20px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      ...
                      <h3 style={{ fontWeight: 700, color: "#ffffff", fontSize: "0.9rem" }}>Student Join Code</h3>
                    </div>
                  ...
                  {/* Class settings */}
                  <div style={{ background: "#111c30", border: "1px solid rgba(239,68,68,.2)", borderRadius: 14, padding: "20px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                      <AlertCircle size={16} color="#EF4444" />
                      <h3 style={{ fontWeight: 700, color: "#EF4444", fontSize: "0.9rem" }}>Class Settings</h3>
                    </div>
                    <p style={{ color: "#4a6a8a", fontSize: "0.78rem", marginBottom: 14 }}>Manage class status.</p>
                    <button onClick={async () => {
